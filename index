...
window.addEventListener('load', () => {
  ...
  let labelName = Html('label')
      .setClass('control-label')
      .setAttribute('htmlFor', 'name')
      .setAttribute('innerHTML', '姓名');

  let divName = Html('div')
      .setClass('h-field')
      .appendChild(labelName.node)
      .appendChild(pName.node);

  let Hp = Html('input')
      .setClass('input')
      .setAttribute('placeholder', '5000')
      .setAttribute('id', 'hp')
  ...
  let divHp = Html('div')
      .setClass('h-field')
      .appendChild(labelHp.node)
      .appendChild(pHp.node);

  let Ap = Html('input')
      .setClass('input')
      .setAttribute('placeholder', '3000')
      .setAttribute('id', 'ap')
      .setAttribute('type', 'number');
  ...
  let divAp = Html('div')
      .setClass('h-field')
      .appendChild(labelAp.node)
      .appendChild(pAp.node);
  ...
  let divDp = Html('div')
      .setClass('h-field')
      .appendChild(labelDp.node)
      .appendChild(pDp.node);

  let mid = Html('div')
      .setClass('pane')
      .appendChild(divName.node)
      .appendChild(divHp.node)
      .appendChild(divAp.node)
      .appendChild(divDp.node);
